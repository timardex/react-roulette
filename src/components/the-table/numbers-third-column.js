...
const NumbersThirdColumn = props => {
    return (
        <div className="third-column columns">
            {props.number_third_column.map((value, index) => {
                return (
...
function mapStateToProps(state) {
    return {
        ...
        number_third_column: state.number_third_column,
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(NumbersThirdColumn);